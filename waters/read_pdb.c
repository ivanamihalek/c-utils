...
int read_pdb ( char * pdbname, Protein * protein, int * chain_number,
	...
	/* ligand?*/
	is_ligand =  ! strncmp(line,"HETATM", 6);
	if (is_ligand) {
	    ligand_ctr ++;
	    continue;
	}
